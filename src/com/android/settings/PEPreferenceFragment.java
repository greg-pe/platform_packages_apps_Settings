 ...
 */
public class PEPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    public static class SettingsDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                ...
                if (mParentFragment instanceof PEPreferenceFragment) {
                    // restore mDialogFragment in mParentFragment
                    ((PEPreferenceFragment) mParentFragment).mDialogFragment = this;
                }
            }
        ...
        public void onDetach() {
            ...
            if (mParentFragment instanceof PEPreferenceFragment) {
                ...
                if (((PEPreferenceFragment) mParentFragment).mDialogFragment == this) {
                    ((PEPreferenceFragment) mParentFragment).mDialogFragment = null;
                }
            }
        }
    }
